  ...
  <div class="container clearfix">
    <div class="people-list" id="people-list">
      <div class="button-align-right">
        <span class="change-account">Start a conversation</span> &nbsp; &nbsp;&nbsp;&nbsp;
        <a class="logout" href='../Signin-signup/signout.php'>Logout</a>
      </div>
      <div class="search">
        ...
        <ul>
          <li class="clearfix">
            <div class="message-data align-right">
              <span class="message-data-time">10:10 AM, Today</span><span>&nbsp; &nbsp;</span>
